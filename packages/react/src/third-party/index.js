...
let z = class extends qt(Zt) {
  ...
  render() {
    ...
    return f`
      <nav class="${
        ((t =
          this.themeOptions[(s = this.navOptions) == null ? void 0 : s.mode]) ==
        null
          ? void 0
      ...
      ${
        ((i =
          this.themeOptions[(e = this.navOptions) == null ? void 0 : e.mode]) ==
        null
          ? void 0
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              ...
              <div class="flex flex-shrink-0 items-center font-bold  pl-4 ${
                ((Q =
                  ...
                  ? void 0
                  : Q.headerTextColor) || this.themeOptions.dark.headerTextColor
